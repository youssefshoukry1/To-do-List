...
export default function Home() {
  ...
  return (
<section className="p-4 sm:p-6 flex flex-col justify-center items-center min-h-screen bg-gray-900 text-gray-200">
  {/* العنوان */}
  <motion.h1
  ...
  <motion.form
    ...
    animate={{ opacity: 1, y: 0 }}
    transition={{ duration: 0.6 }}
    className="w-full max-w-full md:max-w-2xl bg-gray-800 shadow-lg rounded-2xl p-4 sm:p-6 flex flex-col gap-5 lg:h-[65vh] h-[58vh] lg:mb-0 mb-12" 
  ...
  >
    ...
    <div className="flex flex-col sm:flex-row gap-3">
      ...
      <motion.button
        ...
        className="px-4 py-2 sm:px-6 sm:py-3 bg-red-600 hover:bg-red-700 rounded-xl text-white font-medium sm:font-semibold shadow-md text-sm sm:text-base w-full sm:w-auto"
      >
        Delete All
      </motion.button>
    </div>
    ...
    {/* Tasks */}
    <div className=" tasks-scroll bg-gray-700 rounded-xl p-3 sm:p-4 space-y-3 flex-1 overflow-y-auto">
      {tasks.length === 0 && (

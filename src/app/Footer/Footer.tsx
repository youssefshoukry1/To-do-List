...
export default function Footer() {
  ...
  return (
    <motion.footer
      ...
      className={`w-full py-6 px-8 flex justify-center items-center shadow-inner transition-colors duration-500 ${
          mood === "light"
      ? "bg-gradient-to-br from-[rgb(235,190,228)] via-[rgb(245,210,235)] to-[rgb(225,170,215)] text-[#3b0a2e]"
      : "bg-gradient-to-b to-[#121212] from-[#1E1E1E] text-gray-200"
      }`}
    >
      <a
